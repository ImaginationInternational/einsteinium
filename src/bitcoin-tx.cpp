...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s imagination-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  imagination-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded imagination transaction") + "\n" +
              "  imagination-tx [options] -create [commands]   " + _("Create hex-encoded imagination transaction") + "\n" +
              "\n";
